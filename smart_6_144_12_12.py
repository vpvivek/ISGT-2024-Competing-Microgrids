...
price_array1 = np.array([1, 2, 3]) # 3 possible prices valued 1,2,3
...
price_array2 = np.array([1, 2, 3])  #3 possible prices valued 1,2,3
...
#Main grid
price_array_Main = np.array([1, 2, 3]) # 3 possible prices valued 1,2,3
maximum_Mainprice = max(price_array_Main)
priceTPM_Main = np.array([[0.3, 0.15, 0.55], [0.2, 0.40, 0.4], [0.4, .25, .35]])
maximum_MainGrid = 3
