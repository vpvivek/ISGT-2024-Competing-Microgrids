...
demand_array = np.array([1, 2]) # 3 possible demands valued 1,2,3
maximum_demand = max(demand_array)
demandTPM = np.array([[0.8, 0.2], [0.6, 0.4]])
...
renewal_array1 = [1, 2] # 3 possible renewal energy valued 1,2,3
renewalProb1 = np.array([0.3, 0.7])
...
maximum_battery1 = 2  #capacity of battery
current_battery1 = 0  #available power at a particular instant of time

#Microgrid 2
    #renewal
renewal_array2 = np.array([1,2])  #3 possible renewal energy valued 1,2,3
renewalProb2 = np.array([0.25, 0.75])
...
maximum_battery2 = 2 #capacity of battery
...
priceTPM_Main = np.array([[0.65, 0.35],[0.35, 0.65]])
maximum_MainGrid = 2
...
No_of_price_actions1 = max(price_array1)
No_of_price_actions2 = max(price_array2)
No_of_purchase_actions1 = maximum_MainGrid + 1
No_of_purchase_actions2 = maximum_MainGrid + 1
